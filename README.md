...
- Carteira Digital: Adicione, utilize e saque saldo com histórico de transações.
...
Apenas usuários que possuem o jogo podem avaliá-lo com nota (0-5), comentário e recomendação. Permitida apenas uma review por usuário por jogo, com possibilidade de edição.

4. Oficina de Mods
Disponível para jogos habilitados pelo desenvolvedor. Usuários que possuem o jogo podem enviar mods e se inscrever para receber notificações de novas versões.

5. Publicação de Jogo
Apenas contas de desenvolvedor podem publicar. O sistema valida a unicidade do nome do jogo por desenvolvedor e a unicidade global do slug. Requer título, descrição, capa, mídias e tags.

6. Comprar um Jogo (E-Commerce)
Usuários podem comprar jogos publicados, usando saldo da carteira se desejarem. Um recibo é gerado para todas as transações. Reembolsos são possíveis em até 24h se o jogo não for baixado.

7. Baixar Jogo
O jogo deve estar na biblioteca do usuário. Para acesso antecipado, é necessária uma key válida.

8. Crowdfunding
Desenvolvedores podem criar campanhas de arrecadação para jogos não publicados, definindo meta e regras. Jogadores podem contribuir e pedir reembolso em até 24h.
...
10. Saldo (Carteira)
Permite adicionar e sacar saldo, com histórico de transações e regras de segurança e prazos para liberação de valores para saque.
