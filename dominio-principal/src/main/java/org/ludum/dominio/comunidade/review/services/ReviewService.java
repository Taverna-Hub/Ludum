package org.ludum.dominio.comunidade.review.services;
...
public class ReviewService {
     ...
     * - A review deve conter: Nota (0-5) estrelas, Comentário (texto), Recomendação
     * (true/false).
     */
    public void avaliarJogo(JogoId jogoId, ContaId autorId, int nota, String titulo, String texto, boolean recomenda) {
        ...
        if (reviewRepository.obterPorAutorEJogo(autorId, jogoId).isPresent()) {
            throw new IllegalArgumentException(
                    "Você já avaliou este jogo. Use a função de editar para alterar sua avaliação.");
        }
     ...
     * - Excluir a review significa desativar/ocultar (não apagar do banco, para
     * manter histórico).
